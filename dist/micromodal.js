  ...
  var MicroModal = function () {
    ...
    var Modal = /*#__PURE__*/function () {
      function Modal(_ref) {
        ...
        this.onKeydown = this.onKeydown.bind(this); // save modal id

        this.id = targetModal; // Add class to say this element has been initialized

        try {
          this.modal.classList.add('micromodal-initialized');
        } catch (e) {
          throw 'Could not initialize ' + targetModal;
      ...
      _createClass(Modal, [{
        ...
        value: function setFocusToFirstNode() {
          ...
          var nodesWhichAreNotCloseTargets = focusableNodes.filter(function (node) {
            return !node.hasAttribute(_this4.config.closeTrigger);
          });
    ...
    var activeModal = null; // Keep an array of open modals so that esc key only closes top-most modal
    ...
    var onKeyDown = function onKeyDown(event) {
      if (event.keyCode === 27) {
        if (openModals.length > 0) {
          ...
          if (currentModal) currentModal.closeModal(event);
        }
      }
    };
    /**
    ...
    var show = function show(targetModal, config) {
      var options = config || {};
      options.targetModal = targetModal.replace(/^#/, ''); // Checks if modals and triggers exist in dom
     ...
     * @param {object} [event] Calling event object
     * @return {void}
     */


    var close = function close(targetModal, event) {
      var modalToClose = {};
