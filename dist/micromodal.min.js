...
return function(){var i=["a[href]","area[href]",'input:not([disabled]):not([type="hidden"]):not([aria-hidden])',"select:not([disabled]):not([aria-hidden])","textarea:not([disabled]):not([aria-hidden])","button:not([disabled]):not([aria-hidden])","iframe","object","embed","[contenteditable]",'[tabindex]:not([tabindex^="-"])'],n=function(){function n(t){var i=t.targetModal,a=t.triggers,r=void 0===a?[]:a,s=t.onShow,l=void 0===s?function(){}:s,d=t.onClose,c=void 0===d?function(){}:d,u=t.openTrigger,f=void 0===u?"data-micromodal-trigger":u,h=t.closeTrigger,v=void 0===h?"data-micromodal-close":h,g=t.disableScroll,m=void 0!==g&&g,b=t.disableFocus,y=void 0!==b&&b,p=t.awaitCloseAnimation,w=void 0!==p&&p,k=t.debugMode,E=void 0!==k&&k
t.id
e(this,n),this.modal=document.getElementById(i),this.config={debugMode:E,disableScroll:m,openTrigger:f,closeTrigger:v,onShow:l,onClose:c,awaitCloseAnimation:w,disableFocus:y},r.length>0&&this.registerTriggers.apply(this,o(r)),this.onClick=this.onClick.bind(this),this.onKeydown=this.onKeydown.bind(this),this.id=i}return t(n,[{key:"registerTriggers",value:function(){for(var e=this,t=arguments.length,o=Array(t),i=0;i<t;i++)o[i]=arguments[i]
...
e.shiftKey&&0===o&&(t[t.length-1].focus(),e.preventDefault()),e.shiftKey||o!==t.length-1||(t[0].focus(),e.preventDefault())}else t[0].focus()}}]),n}(),a=null,r=[],s=function(e,t){var o=[]
return e.forEach(function(e){var i=e.attributes[t].value
void 0===o[i]&&(o[i]=[]),o[i].push(e)}),o},l=function(e){if(!document.getElementById(e))return console.warn("MicroModal v0.3.2: ❗Seems like you have missed %c'"+e+"'","background-color: #f8f9fa;color: #50596c;font-weight: bold;","ID somewhere in your code. Refer example below to resolve it."),console.warn("%cExample:","background-color: #f8f9fa;color: #50596c;font-weight: bold;",'<div class="modal" id="'+e+'"></div>'),!1},d=function(e){if(e.length<=0)return console.warn("MicroModal v0.3.2: ❗Please specify at least one %c'micromodal-trigger'","background-color: #f8f9fa;color: #50596c;font-weight: bold;","data attribute."),console.warn("%cExample:","background-color: #f8f9fa;color: #50596c;font-weight: bold;",'<a href="#" data-micromodal-trigger="my-modal"></a>'),!1},c=function(e,t){if(d(e),!t)return!0
for(var o in t)l(o)
return!0},u=function(e){if(27===e.keyCode&&r.length>0){var t=r[r.length-1]
t&&t.closeModal()}}
return{init:function(e){var t=Object.assign({},{openTrigger:"data-micromodal-trigger"},e),i=[].concat(o(document.querySelectorAll("["+t.openTrigger+"]"))),a=s(i,t.openTrigger)
if(!0!==t.debugMode||!1!==c(i,a)){for(var r in a){var l=a[r]
t.targetModal=r,t.triggers=[].concat(o(l)),new n(t)}document.addEventListener("keydown",u)}},show:function(e,t){var o=t||{}
o.targetModal=e.replace(/^#/,""),!0===o.debugMode&&!1===l(e)||(a=new n(o),a.showModal())},close:function(e){var t={}
e?(e=e.replace(/^#/,""),t=r.filter(function(t){return t.id===e})[0]):t=r[r.length-1],t.closeModal()}}}()})
