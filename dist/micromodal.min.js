...
return function(){var i=["a[href]","area[href]",'input:not([disabled]):not([type="hidden"]):not([aria-hidden])',"select:not([disabled]):not([aria-hidden])","textarea:not([disabled]):not([aria-hidden])","button:not([disabled]):not([aria-hidden])","iframe","object","embed","[contenteditable]",'[tabindex]:not([tabindex^="-"])'],n=function(){function n(t){var i=t.targetModal,a=t.triggers,r=void 0===a?[]:a,l=t.onShow,s=void 0===l?function(){}:l,c=t.onClose,d=void 0===c?function(){}:c,u=t.openTrigger,f=void 0===u?"data-micromodal-trigger":u,h=t.closeTrigger,v=void 0===h?"data-micromodal-close":h,g=t.disableScroll,m=void 0!==g&&g,b=t.disableFocus,y=void 0!==b&&b,p=t.awaitCloseAnimation,w=void 0!==p&&p,k=t.debugMode,E=void 0!==k&&k
t.id
